...
[InvocationCount(1)]
public class IndexingPhasedBenchmarks
{
    private static readonly string[] PhaseNames =
    [
        Diagnostics.LeanCorpusActivitySource.AddDocument,
        Diagnostics.LeanCorpusActivitySource.Analyse,
    ...
    public void IterationSetup()
    {
        ...
        _indexPath = Path.Combine(Path.GetTempPath(), $"leancorpus-prof-index-{Guid.NewGuid():N}");
    ...
    private void DumpPhaseBreakdown()
    {
        ...
        {
            Console.Error.WriteLine("  [profiling] No activity spans captured — is ActivitySource configured?");
            return;
        }
        ...
        Console.Error.WriteLine($"  == Indexing Phase Breakdown ({DocumentCount:N0} docs) ==");
