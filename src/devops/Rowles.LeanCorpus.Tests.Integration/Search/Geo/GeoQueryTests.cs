...
namespace Rowles.LeanCorpus.Tests.Integration.Search.Geo;
...
{
    private readonly string _dir = Path.Combine(Path.GetTempPath(), "leancorpus_geo_" + Guid.NewGuid().ToString("N")[..8]);
