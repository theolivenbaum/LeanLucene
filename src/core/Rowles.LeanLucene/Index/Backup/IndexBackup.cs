...
namespace Rowles.LeanLucene.Index.Backup;

/// <summary>
/// Creates, validates, and restores LeanLucene index backups.
/// </summary>
public static class IndexBackup
{
    ...
    public const string ManifestFileName = "leanlucene-backup-manifest.json";
    ...
    private static IndexBackupManifest CreateManifestCore(string indexDirectoryPath, IndexBackupOptions options)
    {
        ...
        var commitData = JsonSerializer.Deserialize(commitJson, LeanLuceneJsonContext.Default.CommitData)
    ...
    public static IndexBackupManifest ReadManifest(string backupDirectoryPath)
    {
        ...
        var manifest = JsonSerializer.Deserialize(json, LeanLuceneJsonContext.Default.IndexBackupManifest)
